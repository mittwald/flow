...
| `packages/remote-vue-components`        | `@mittwald/flow-remote-vue-components`   | **Prototype, unpublished.** Vue API for remote apps; mirrors the React one, auto-generated. |
...
| Vue API for remote apps (prototype)         | [packages/remote-vue-components/AGENTS.md](packages/remote-vue-components/AGENTS.md)    |
