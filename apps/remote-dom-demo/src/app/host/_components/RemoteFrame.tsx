...
/**
 * Folded away by default: the list grows with the demo — the `list` page alone
 * reports thirty-odd components — and pushed the demo itself below the fold.
 */
...
interface Props {
  /** The remote app to load — a `/remote/…` or `/remote-vue/…` route. */
  src: string;
  hostPathname: string;
}
