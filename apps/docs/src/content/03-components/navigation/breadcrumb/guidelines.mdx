...
- ein sinnvoller Startpunkt gewählt wird. Bei Produktseiten bietet sich
  beispielsweise die Landingpage als Startpunkt an. Im mStudio beginnt die
  Breadcrumb z. B. auf Projekt-, Server- oder Organisationsebene.
...
- auf kleineren Benutzeroberflächen die Breadcrumb die aktuelle Position nicht
  anzeigt, um Platz zu sparen. Stattdessen wird die aktuelle Seite durch den
  Titel ([H1](/03-components/content/heading/overview)) kommuniziert.
