...
- sie oberhalb von einer [LayoutCard](/03-components/structure/layout-card) positioniert werden.
- bei Statusanzeigen innerhalb eines Tabs – z. B. durch einen Danger-[Alert](/03-components/status/alert) – der Tab selbst ein entsprechendes Status-Icon erhält, um die Aufmerksamkeit darauf zu lenken.
