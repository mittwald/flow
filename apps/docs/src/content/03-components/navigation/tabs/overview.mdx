...
Wenn der Inhalt eines Tabs eine wichtige Information oder Warnung enthält (z. B. in Form eines [Alerts](/03-components/status/alert/overview)), muss der entsprechende Tab ein Status-Icon erhalten.
