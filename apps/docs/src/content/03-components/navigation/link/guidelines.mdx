...
- Links nur als Navigationselement gedacht sind. Links können z. B. keine
  [Modals](/03-components/overlays/modal/overview) öffnen, keine Aktionen bestätigen und
  keine weiteren Informationen aufklappen lassen
  ([Accordion](/03-components/structure/accordion/overview)).
...
Links und [Buttons](/03-components/actions/button/overview) werden häufig verwechselt. Um
...
- In einer [Section](/03-components/structure/section/overview) können Links in der
  oberen rechten Ecke neben der [Heading](/03-components/content/heading/overview)
...
- Im unteren Bereich einer Section oder eines
  [Textblocks](/03-components/content/text/overview) können ein oder mehrere Links
  angezeigt werden. Diese sollten sich auf den vorangehenden Text beziehen.
- Inline Links werden direkt im [Text](/03-components/content/text/overview) eingefügt.
