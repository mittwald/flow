...
In der LightBox kann eine [ActionGroup](/03-components/actions/action-group/overview)
...
Als Trigger kann auch das [Image](/03-components/content/image/overview) selbst verwendet
