...
- sie das finale Layout der Benutzeroberfläche so gut wie möglich widerspiegeln,
  ...
  [Avatare](/03-components/content/avatar) oder
  [Images](/03-components/content/image).
...
- sie ausschließlich für das initiale und kurzzeitige Laden von Inhalten
  ...
  [LoadingSpinner](/03-components/status/loading-spinner).
...
[Listes](/03-components/structure/list), [Images](/03-components/content/image)
oder [Texte](/03-components/content/text) darzustellen – sie bieten
