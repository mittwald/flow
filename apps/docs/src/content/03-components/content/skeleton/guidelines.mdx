...
- sie das finale Layout der Benutzeroberfläche so gut wie möglich widerspiegeln,
  ...
  [Avatare](/03-components/content/avatar/overview) oder
  [Images](/03-components/content/image/overview).
...
- sie ausschließlich für das initiale und kurzzeitige Laden von Inhalten
  ...
  [LoadingSpinner](/03-components/status/loading-spinner/overview).
...
[Listes](/03-components/structure/list/overview), [Images](/03-components/content/image/overview)
oder [Texte](/03-components/content/text/overview) darzustellen – sie bieten
