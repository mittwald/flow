...
`color`-Property um Teile von [Text](/03-components/content/text) oder
[Headings](/03-components/content/heading) gelegt wird. Sie kommt nur in
...
Teile eines [Textes](/03-components/content/text) lassen sich mithilfe der
...
[Headings](/03-components/content/heading) gezielt wichtige Wörter farblich
hervorheben.
...
[Headings](/03-components/content/heading) in
[AccentBoxen](/03-components/structure/accent-box) mit Werbeinhalten. Dabei ist
