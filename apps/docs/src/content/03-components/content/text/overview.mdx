...
`<strong>` oder `font-weight: bold` haben würde. Das ist z. B. wichtig, um ein
Springen der Menüpunkte zu vermeiden, wenn der aktive Menüpunkt einer Navigation
in `bold` dargestellt wird.
...
Lightness-Wert von weniger als 50. **Dark**: Verwende die Dark-Color bei hellen,
farbigen Hintergründen mit einem HSL Lightness-Wert von größer als 50.
