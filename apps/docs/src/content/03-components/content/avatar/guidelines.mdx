...
- wenn mehrere Avatare nebeneinander dargestellt werden sollen, ein [AvatarStack](/03-components/content/avatar-stack) verwendet wird, um die Darstellung kompakt und übersichtlich zu halten.
