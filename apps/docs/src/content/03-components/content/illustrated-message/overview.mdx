...
Bei Fehlern oder unzulässigem Zugriff hilft die IllustratedMessage Usern dabei zu verstehen, was nicht funktioniert und warum. Zusätzlich kann sie eine mögliche Lösung anbieten. Im Vergleich zu einem [Alert](https://mittwald.github.io/flow/03-components/status/alert) wirkt sie freundlicher und gleicht fehlende Inhalte visuell besser aus.
...
Wenn mehr als eine Action benötigt wird, kann die IllustratedMessage auch mit einer [ActionGroup](https://mittwald.github.io/flow/03-components/actions/action-group) kombiniert werden.
