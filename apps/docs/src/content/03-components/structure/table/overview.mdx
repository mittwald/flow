...
Der Inhalt wird durch horizontal zentriert ausgerichtet. Unabhängig von der Ausrichtung unterstützt die Table optional die Statusanzeigen `success` und `danger`.
