...
Nutze `<List.Table />`, um die List als [Table](/03-components/structure/table) darzustellen.
...
[Checkboxen](/03-components/form-controls/checkbox) in einem ListItem werden automatisch am Anfang der Zeile angeordnet. Die Funktionalität der Checkbox wird nicht von der List gesteuert und muss individuell implementiert werden. Achte bei der Implementierung jedoch
