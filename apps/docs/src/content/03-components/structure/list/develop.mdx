...
In der Regel werden Filter für ein Property der Liste gesetzt:
...
Es gibt die Möglichkeit eigene Properties, die nicht in der Liste vorkommen, zu
verwenden. Hierfür muss dem `property` ein "$" vorangestellt werden:
...
Die Liste unterstützt eine Sortierung nach Properties:
