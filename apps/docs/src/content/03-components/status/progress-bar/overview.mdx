...
automatisch die [Legend-Component](https://mittwald.github.io/flow/03-components/content/legend) angezeigt. Über das `showLegend` Property
...
werden, dass nebeneinanderliegende Farben weiterhin einen ausreichenden
