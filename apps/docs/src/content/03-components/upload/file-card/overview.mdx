...
[FileCardList](/03-components/upload/file-card-list/overview) erweitert werden.
...
[Button](/03-components/actions/button/overview) anzuzeigen, mit dem die Datei
...
einem [ContextMenu](/03-components/actions/context-menu/overview) zu platzieren.
