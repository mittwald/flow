...
[FileCardList](/03-components/upload/file-card-list) erweitert werden.
...
[Button](/03-components/actions/button) anzuzeigen, mit dem die Datei
...
einem [ContextMenu](/03-components/actions/context-menu) zu platzieren.
