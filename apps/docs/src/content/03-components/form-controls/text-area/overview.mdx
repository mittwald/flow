...
[Label](/03-components/content/label/overview) zu beschreiben. Zusätzliche Hinweise, etwa
zur Formatierung, können über die `<FieldDescription />` ergänzt werden.
...
Benutze die [Align](/03-components/structure/align/overview)-Component, um andere
Components, wie einen [Button](/03-components/actions/button/overview), neben der
