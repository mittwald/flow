...
[CheckboxButton](/03-components/form-controls/checkbox-button/overview). Der Unterschied
...
- bei mehreren Checkboxen die Reihenfolge logisch und nachvollziehbar ist (siehe
  [CheckboxGroup](/03-components/form-controls/checkbox-group/overview)).
...
Mit den Components Checkbox und [Switch](/03-components/form-controls/switch/overview)
können Optionen aktiviert/ausgewählt werden. Um die Unterschiede klarer zu
machen, hier einige hilfreiche Anhaltspunkte.
