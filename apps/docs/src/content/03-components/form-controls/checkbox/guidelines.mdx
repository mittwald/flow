...
[CheckboxButton](/03-components/form-controls/checkbox-button). Der Unterschied
...
- bei mehreren Checkboxen die Reihenfolge logisch und nachvollziehbar ist (siehe
  [CheckboxGroup](/03-components/form-controls/checkbox-group)).
...
Mit den Components Checkbox und [Switch](/03-components/form-controls/switch)
