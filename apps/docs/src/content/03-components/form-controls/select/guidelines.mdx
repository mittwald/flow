...
- die Anzahl der Optionen überschaubar bleibt. Bei sehr vielen Einträgen kann
  z. B. eine [ComboBox](/03-components/form-controls/combo-box) die bessere Wahl
  sein.
...
- eine Einfachauswahl bereitzustellen. Diese sollte aus mindestens zwei Optionen
  ...
  [RadioGroup](/03-components/form-controls/radio-group)).
- Platz zu sparen, wenn beispielsweise eine
  [RadioGroup](/03-components/form-controls/radio-group) oder ein
  [SegmentedControl](/03-components/form-controls/segmented-control) zu viel
