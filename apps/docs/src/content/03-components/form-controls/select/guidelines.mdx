...
- das [Label](/03-components/content/label/overview) kurz und deutlich formuliert ist.
...
- die Anzahl der Optionen überschaubar bleibt. Bei sehr vielen Einträgen kann
  z. B. eine [ComboBox](/03-components/form-controls/combo-box/overview) die bessere Wahl
  sein.
...
- eine Einfachauswahl bereitzustellen. Diese sollte aus mindestens zwei Optionen
  ...
  [RadioGroup](/03-components/form-controls/radio-group/overview)).
- Platz zu sparen, wenn beispielsweise eine
  [RadioGroup](/03-components/form-controls/radio-group/overview) oder ein
  [SegmentedControl](/03-components/form-controls/segmented-control/overview) zu viel
