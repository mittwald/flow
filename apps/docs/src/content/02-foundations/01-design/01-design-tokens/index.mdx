...
Dieser Token definiert eine Designentscheidung für eine spezifische Komponente,
...
bestimmte Komponente relevant sind. Sie enthalten den höchsten Detailgrad der
