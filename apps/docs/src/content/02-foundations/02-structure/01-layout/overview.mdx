...
[HeaderNavigation](/03-components/navigation/header-navigation/overview) enthalten. Ein
Hauptbestandteil der HeaderNavigation sind primäre Navigationspunkte. Ergänzend
gibt es [Buttons](/03-components/actions/button/overview), die Overlays oder
[ContextMenus](/03-components/actions/context-menu/overview) öffnen, wie beispielsweise
...
[LayoutCard](/03-components/structure/layout-card/overview) mit der Component
[Navigation](/03-components/navigation/navigation/overview) gefüllt werden.
...
Im Content-Bereich können [Tabs](/03-components/navigation/tabs/overview) und
...
über eine List, bietet eine [Breadcrumb](/03-components/navigation/breadcrumb/overview)
eine Orientierungshilfe.

Der Content wird von einer [LayoutCard](/03-components/structure/layout-card/overview)
...
[Section](/03-components/structure/section/overview) und
[ColumnLayout](/03-components/structure/column-layout/overview) verwendet werden.

## Overlay

Ein Overlay öffnet sich über der eigentlichen Seite. Größere Overlays wie
[Modals](/03-components/overlays/modal/overview) und
[OffCanvas](/03-components/overlays/modal/overview) erhalten zusätzlich einen Backdrop,
damit sich der User besser auf den angezeigten Inhalt konzentrieren kann.
Andere, kleinere Overlays wie [ContextMenu](/03-components/actions/context-menu/overview)
oder [Tooltip](/03-components/overlays/tooltip/overview) erhalten keinen Backdrop für die
