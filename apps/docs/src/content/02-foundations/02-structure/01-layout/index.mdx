...
Komponenten und deren Komposition bestimmt. In unseren Komponenten ist das
...
[LayoutCard](/04-components/structure/layout-card/overview) mit der Komponente
...
[List](/04-components/structure/list/overview) verwendet werden, um die Inhalte
zu teilen oder in die Tiefe zu navigieren. Bei der Navigation in tiefere Ebenen,
z. B. über eine List, bietet eine
...
Richtung sicherzustellen, sollten die Layout-Komponenten
