...
Boundaries übernehmen das Rendering der jeweiligen Elemente. Spezielle
„Fragment“-Boundaries kümmern sich ausschließlich um die Lade- und
Fehlerzustände des Elements, ohne das vollständige Element zu rendern.
...
| `Modal`                             | Ersetzt normale Modals                                         | <LiveCodeEditor example="modal-error" editorDisabled zoom=".6" />                      | LoadingView der Flow Component                                                           |
