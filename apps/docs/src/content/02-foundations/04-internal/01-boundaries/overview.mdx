...
wir zuerst geladen, damit im Fehlerfall für die gesamte Seite eine ErrorView
...
Für Modals sollte immer in ein `WithBoundaries.Modal` verwendet werden. Dies
...
Diese sollten daher seperat geschützt werden, um nicht die gesamte Seite zu
