...
nachgeladene Inhalte benötigen in ein `MenuItemFragment` gepackt; diese Boundary
...
`LayoutCardFragmentWithBoundaries`, `TextWithBoundaries`,
`StringWithBoundaries`, `FieldFragmentWithBoundaries`,
`LinkFragmentWithBoundaries`, `ChartFragmentWithBoundaries` u. a.
