...
umschlossen sein. Dieser sollte die Anzahl der geladenen Sections als
SectionsCount mitgegeben werden, um die LoadingView entsprechend anzuzeigen.
...
- `WithBoundaries.LayoutCard` mit SectionCount, je nach Anzahl der Sections
