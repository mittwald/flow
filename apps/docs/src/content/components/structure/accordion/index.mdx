...
Statt einer [Heading](/components/content/heading) kann auch ein
[Label](/components/content/label) verwendet werden. Ein Label eignet sich, wenn
der Inhalt ergänzend oder sekundär ist und nicht im Fokus der Seite steht – zum
