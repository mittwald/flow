...
- Lass auf ein AlertBadge weiterführende Informationen in einem
  [Alert](/components/status/alert) folgen.
- Orientiere dich am
  [Informationskonzept](/foundations/content-guidelines/informationskonzept). Es
  beschreibt das Zusammenspiel der Status-Komponenten.
