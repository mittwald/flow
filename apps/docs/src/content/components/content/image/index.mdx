...
Mit der Property `withBorder` erhält die Image-Component eine Border. Sie hilft,
wenn sich ein Bild nicht zuverlässig vom Hintergrund abhebt – etwa weil nicht
vorhersehbar ist, welche Bilder angezeigt werden. Helle oder dunkle Bildränder
verschwimmen sonst je nach Hintergrundfarbe mit der Umgebung. Die Border grenzt
das Bild klar ab.
