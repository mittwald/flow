...
Flow bringt `@tabler/icons-react` nicht mit – die Icons der Icon-Bibliothek sind
direkt in `@mittwald/flow-icons` enthalten. Für ein Icon außerhalb der
Bibliothek installierst du das Package selbst:
...
Benutze die [Combine](/components/structure/combine)-Component, um ein Icon
