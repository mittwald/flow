...
- Platziere den SkeletonText in der Component, die später den Text enthält (z.
  B. [Text](/components/content/text) oder
  [Heading](/components/content/heading)). So entspricht seine Höhe der finalen
  Typografie und es entsteht kein Layout-Sprung.
...
SkeletonText und [Skeleton](/components/content/skeleton) haben dasselbe
...
<DoAndDont>
  ...
  <Plain heading="Verwende Skeleton für ...">
    ...
    - Bilder, [Avatare](/components/content/avatar) und andere grafische Elemente.
...
[Heading](/components/content/heading), damit er deren Schriftgröße übernimmt.
