...
- Spiegele das finale Layout so gut wie möglich wider. Nutze vereinfachte Formen
  für [Avatare](/components/content/avatar) oder
  [Images](/components/content/image), damit User die erwarteten Inhalte
  erkennen.
...
Skeleton und [SkeletonText](/components/content/skeleton-text) haben dasselbe
