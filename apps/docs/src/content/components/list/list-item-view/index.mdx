...
Im Untertitel werden alle `Text`-Components durch einen Strich getrennt in einer
Zeile dargestellt. Um eine dieser Angaben zu erklären, setze innerhalb des
`Text` eine [Combine](/components/structure/combine) aus dem Text und einem
[ContextualHelp](/components/overlays/contextual-help) – sie bleibt dabei Teil
der Zeile.

<LiveCodeEditor example="item-contextual-help" editorCollapsed />
