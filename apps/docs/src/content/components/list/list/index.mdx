...
- Hat ein Filter mit `mode="some"` **mindestens 10 Optionen**, erscheint oben
  automatisch die Option „Alle“. Damit wählen User alle Optionen auf einmal aus
  und können danach gezielt einzelne abwählen. Sind nur einige Optionen gewählt,
  zeigt „Alle“ einen Zwischenzustand.
