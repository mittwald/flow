...
[List.ItemView](/components/list/list-item-view), die Avatar, Titel, Content und
...
- Hat ein Filter mit `mode="some"` **mindestens 6 Optionen**, erscheint oben
  automatisch die Option „Alle auswählen“. Damit wählen User alle Optionen auf
  einmal aus und können danach gezielt einzelne abwählen. Sind alle Optionen
  gewählt, wird daraus „Alle abwählen“; sind nur einige gewählt, zeigt die
  Checkbox einen Zwischenzustand.
...
- Er gilt für alle View Modes — Liste, Raster und Tabelle.
