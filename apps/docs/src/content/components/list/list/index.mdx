...
Ein [ListItem](/components/list/list-item) repräsentiert ein einzelnes Element
der List (z. B. eine Domain, E-Mail-Adresse oder ein Projekt) und stellt dessen
wichtigste Informationen übersichtlich dar.
