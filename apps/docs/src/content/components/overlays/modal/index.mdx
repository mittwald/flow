...
automatisch, sobald sie ungespeicherte Änderungen enthält. Soll eine einzelne
Form das nicht auslösen, setzt du an ihr
`confirmModalCloseOnUnsavedChanges={false}`. Ohne Form – oder wenn du selbst
entscheiden willst, wann es etwas zu verlieren gibt – setzt du `confirmOnClose`.
