...
Damit es über dem Seiteninhalt liegt, beansprucht es `z-index: 1` – die
niedrigste Stufe, die dafür reicht. Anwendungs-Chrome, das darüber bleiben soll
– etwa ein Sticky Header –, braucht deshalb einen höheren Wert.
