...
- Setze [Icons](/components/content/icon) nur ergänzend ein, nicht als alleinige
  Information.
...
Menüeinträge lassen sich optional mit einem [Icon](/components/content/icon)
...
dieser Gruppen eignet sich ein [Label](/components/content/label).
...
[Separator](/components/structure/separator) verwendet werden.

<LiveCodeEditor example="separator" editorCollapsed stretch />

## Badge

Menüeinträge können um ein [Badge](/components/status/badge) erweitert werden um
...
[CounterBadge](/components/status/counter-badge) verwendet werden.
