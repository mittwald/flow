...
- Nutze für [Icons](/components/content/icon) gängige Symbole mit eindeutiger
  Funktion.
...
Nutze einen [Button](/components/actions/button) als Trigger für ein
[ContextMenu](/components/actions/context-menu), um zum Beispiel ein Profil-Menü
zu öffnen. Der Button kann dabei einen [Avatar](/components/content/avatar)
enthalten.
