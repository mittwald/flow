...
Components zusammenzusetzen. Der [Alert](/components/status/alert) besteht
beispielsweise aus einem [Icon](/components/content/icon), einer
[Heading](/components/content/heading) und optionalem Inhalt. Die verwendeten
