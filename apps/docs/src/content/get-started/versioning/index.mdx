...
**TypeScript-Typen, CSS-Klassennamen und Design Tokens** sind best-effort und
fallen nicht unter Semantic Versioning. Eine Änderung daran ist unwahrscheinlich
– wir nehmen sie nicht leichtfertig vor –, aber möglich: Sie kann in jedem
Release erscheinen, auch in einem Patch, ohne Major-Version und ohne
Deprecation-Phase. Wenn du dich auf einen davon stützt, lies „So schützt du
dich“.
