...
Umschließe einen [Button](/04-components/actions/button/overview) mit
`<Action />` und übergib die asynchrone Funktion an das `onAction` Property, um
die States des Buttons automatisch zu steuern.
