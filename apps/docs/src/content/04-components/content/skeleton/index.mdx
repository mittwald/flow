...
- Spiegele das finale Layout so gut wie möglich wider. Nutze vereinfachte Formen
  wie [SkeletonText](/04-components/content/skeleton-text),
  [Avatare](/04-components/content/avatar) oder
...
Skeleton und [SkeletonText](/04-components/content/skeleton-text) haben dasselbe
