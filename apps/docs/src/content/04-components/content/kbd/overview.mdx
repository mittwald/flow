...
`children`. Hierbei ist darauf zu achten, dass Kbd-Komponenten für die einzelnen
Keys gesetzt werden müssen, um semantisch korrekte
...
Die Komponente wird in den Varianten `plain` und `soft` angeboten. Für die
