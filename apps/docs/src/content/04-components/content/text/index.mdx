...
- Texte prägnant, verständlich und hilfreich sind (siehe
  [Sprach-Guide](/02-foundations/03-content-guidelines/01-sprach-guide)).
- die Benutzeroberfläche auch ohne Text verständlich bleibt, da er häufig nur
  unaufmerksam wahrgenommen wird.
- die Zeilenlänge 75 Zeichen nicht überschreitet, da längere Zeilen die
