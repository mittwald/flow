...
<Alert>
  ...
  <Content>
    ...
    [Combine](/04-components/structure/combine) zuständig.
  </Content>
</Alert>
...
- Nutze Flex nicht für Layouts, die sich mit
  [Combine](/04-components/structure/combine) und einem festen UI-Pattern
  umsetzen lassen.
...
- Nutze für ein Layout über mehrere Spalten das
  [ColumnLayout](/04-components/structure/column-layout). Es bricht je
  Breakpoint automatisch um.

## Flex vs. Combine

Flex ist das freie Werkzeug, [Combine](/04-components/structure/combine) das
