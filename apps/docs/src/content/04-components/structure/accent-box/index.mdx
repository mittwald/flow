...
Die AccentBox kann in einen [Link](/04-components/navigation/link) gewrappt
...
[LayoutCard](/04-components/structure/layout-card), füllt sie die gesamte Größe
der LayoutCard aus.
