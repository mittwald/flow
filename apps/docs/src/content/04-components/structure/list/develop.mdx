...
Die Loading View gilt in allen View Modes (List, Tiles, Table) und auch für
einzelne Items, die nach dem initialen Laden noch suspenden – etwa weil ihr
Inhalt eigene Daten nachlädt.
