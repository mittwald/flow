...
nachlädt. Gestalte sie mit [Skeleton](/04-components/content/skeleton/overview)
und `SkeletonText` so, dass sie dem Inhalt in Aufbau und Größe nahekommt, damit
der Übergang ohne Layout-Sprung wirkt.
