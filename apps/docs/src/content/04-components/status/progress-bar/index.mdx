...
Übergib der `<ProgressBar />` über das `value` Property den Fortschritt und
benenne sie mit einem `<Label />`.
...
- **Hebe Schwellenwerte bei der Speicherplatzauslastung visuell hervor.** Ab
  etwa 80 % Auslastung wechselt der Status zur Warning.
