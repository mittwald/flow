...
- Setze den LoadingSpinner nur bei unbestimmter Dauer ein. Bei konkret
  ...
  [ProgressBar](/04-components/status/progress-bar), bei kurzem initialem Laden
  mit bekannter Layout-Struktur ein [Skeleton](/04-components/content/skeleton).
...
- Kombiniere ihn bei längeren Ladezeiten mit einer
  [IllustratedMessage](/04-components/content/illustrated-message). So erhält
