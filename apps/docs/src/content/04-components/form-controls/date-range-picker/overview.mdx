...
Mit `withDatePickerPresets` können Presets angezeigt werden, die eine schnellere
Auswahl von Datumsbereichen ermöglicht.

<LiveCodeEditor example="withPresets" editorCollapsed />
...
<LiveCodeEditor example="withCustomPresets" editorCollapsed />
