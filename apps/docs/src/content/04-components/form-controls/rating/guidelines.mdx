...
Die Rating Komponente dient zur visuellen Darstellung einer Bewertungsskala von
...
- die visuelle Darstellung immer durch ergänzenden Kontext unterstützt wird,
  z. B. durch eine Beschriftung oder eine Kombination mit anderen Komponenten
  wie der [BigNumber](/04-components/data-visualisation/big-number/overview).
