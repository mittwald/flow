...
- **Formuliere das [Label](/04-components/content/label/overview) kurz und
  deutlich.**
- **Nutze einen Placeholder mit klarer Handlungsaufforderung, wenn kein
  sinnvoller Default existiert.** Ein Beispiel ist „Sprache wählen".
...
- **Halte die Zahl der Optionen überschaubar.** Bei sehr vielen Einträgen eignet
  sich eher eine [ComboBox](/04-components/form-controls/combo-box/overview).
- **Ordne die Optionen nachvollziehbar.** Möglich sind alphabetische,
  thematische oder Relevanz-Sortierung.
