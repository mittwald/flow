...
Achte bei der Verwendung von Custom Buttons darauf dass sie ...
...
- die aktuelle Text- und Cursor-Position berücksichtigen (über den
  `MarkdownEditorCustomToolContext` zugänglich) und nach der Aktion sinnvoll
  aktualisieren damit weiterarbeiten werden kann.
