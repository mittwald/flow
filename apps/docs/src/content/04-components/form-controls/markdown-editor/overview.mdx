...
Mit der Property `toolbarTools` lässt sich die Toolbar des Markdown Editors um
eigene Buttons erweitern. So können beispielsweise Mentions, Emojis oder andere
benutzerdefinierte Funktionen integriert werden. `toolbarTools` erwartet ein
Array von `MarkdownEditorCustomTool`-Objekten.
