...
Du kannst den MarkdownEditor um zusätzliche benutzerdefinierte Buttons in der
Toolbar erweitern. Das ist besonders nützlich für spezielle Funktionen wie
Mentions, Emojis oder andere benutzerdefinierte Aktionen.

Verwende hierfür die Property `toolbarTools`, die ein Array von
`MarkdownEditorCustomTool`-Objekten akzeptiert.
