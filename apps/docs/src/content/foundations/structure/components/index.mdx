...
[CounterBadge](/components/status/counter-badge) innerhalb eines
[Buttons](/components/actions/button) platziert, wird dieses automatisch oben
...
1. Unterkomponenten über Props zu übergeben, wie das
   [Icon](/components/content/icon) im Beispiel
