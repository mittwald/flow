...
[Color](/foundations/design/colors). Der Name der Farbe `hosting-blue` gibt den
**Context** an. Die Zahl `800` ist die **Clarification**, die die Abstufung der
Farbe definiert und auf den genauen Farbwert `#0054F5` im Designsystem verweist.
