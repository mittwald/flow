...
Wenn du mehrere Versionen auf einmal aufholst, nimm `flow1` – der Codemod führt
alle Migrations-Codemods auf dem Weg zu `1.0.0` in der Reihenfolge ihrer
Releases aus. Er ersetzt den Migrationsleitfaden nicht: die meisten Einträge
haben keinen Codemod und bleiben Handarbeit.
