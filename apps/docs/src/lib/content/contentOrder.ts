...
export const CONTENT_ORDER: readonly string[] = [
  ...
  "/templates/seiten/auswertungsseite",
  "/templates/seiten/katalogseite",
  "/templates/seiten/zentrierte-karte",
  "/templates/overlays",
  ...
  "/templates/bereiche/listen-pflege",
  "/templates/bereiche/alerts-bereich",
  "/templates/bereiche/loeschen-bereich",
  "/templates/bausteine",
  "/templates/bausteine/formular",
  "/templates/bausteine/listeneintrag",
  "/templates/bausteine/protokollzeile",
  ...
  "/templates/bausteine/hinweiskarte",
  "/components",
];
