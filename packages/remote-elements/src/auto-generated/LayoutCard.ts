...
import type { LayoutCardProps } from "@mittwald/flow-react-components/LayoutCard";
export type { LayoutCardProps } from "@mittwald/flow-react-components/LayoutCard";

export class RemoteLayoutCardElement extends FlowRemoteElement<LayoutCardProps> {
