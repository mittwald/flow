...
export const Header = createRemoteComponent("flr-header", RemoteHeaderElement, {
  eventProps: {
    ...
    onCompositionUpdateCapture: { event: "compositionUpdateCapture" } as never,
    ...
    onGotPointerCaptureCapture: { event: "gotPointerCaptureCapture" } as never,
