...
test.each(testEnvironments)(
  ...
  async ({
    ...
    await expect(container).toMatchScreenshot("FileCard variants");
  },
);

test.each(testEnvironments)(
  "FileCard edge cases (%s)",
  async ({ container, render, components: { FileCard, Flex } }) => {
    await render(
      <Flex gap="m" direction="column">
        <FileCard
    ...
    await expect(container).toMatchScreenshot("FileCard edge cases");
  },
);
