...
test.each(testEnvironments)(
  ...
  async ({
    ...
    await expect(container).toMatchScreenshot("Markdown colors");
  },
);

test.each(testEnvironments)(
  "Markdown content (%s)",
  async ({ container, render, components: { Markdown } }) => {
    await render(
      <Markdown>
        {"# Heading 1\n" +
          "## Heading 2\n" +
    ...
    await expect(container).toMatchScreenshot("Markdown content");
  },
);
