...
test.each(testEnvironments)(
  ...
  async ({
    ...
    await expect(container).toMatchScreenshot("SegmentedControl with Segment");
  },
);
...
test.each(testEnvironments)(
  ...
  async ({
    ...
    await expect(container).toMatchScreenshot(
      "SegmentedControl interaction - default",
    );

    await option.click();

    await expect(container).toMatchScreenshot(
      "SegmentedControl interaction - option selected",
    );
  },
);
...
test.each(testEnvironments)(
  ...
  async ({
    ...
    await expect(container).toMatchScreenshot("SegmentedControl edge cases");
  },
);
