...
test.each(testEnvironments)(
  ...
  async ({ container, render, components: { Flex, ProgressBar, Label } }) => {
    await render(
    ...
    await expect(container).toMatchScreenshot("ProgressBar default");
  },
);

test.each(testEnvironments)(
  "ProgressBar segmented (%s)",
  async ({ container, render, components: { ProgressBar, Label } }) => {
    await render(
      <ProgressBar
        segments={[
    ...
    await expect(container).toMatchScreenshot("ProgressBar segmented");
  },
);
...
test.each(testEnvironments)(
  ...
  async ({ container, render, components: { Flex, ProgressBar, Label } }) => {
    ...
    await expect(container).toMatchScreenshot("ProgressBar edge cases");
  },
);
