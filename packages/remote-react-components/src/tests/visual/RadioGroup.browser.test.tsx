...
test.each(testEnvironments)(
  ...
  async ({
    ...
    await expect(container).toMatchScreenshot("RadioGroup with Radio");
  },
);
...
test.each(testEnvironments)(
  ...
  async ({
    ...
    await expect(container).toMatchScreenshot("RadioGroup with RadioButton");
  },
);

test.each(testEnvironments)(
  "RadioGroup interaction (%s)",
  async ({ container, render, components: { RadioGroup, Radio, Label } }) => {
    await render(
    ...
    await expect(container).toMatchScreenshot(
      "RadioGroup interaction - default",
    );

    await option.click();

    await expect(container).toMatchScreenshot(
      "RadioGroup interaction - option selected",
    );
  },
);
...
test.each(testEnvironments)(
  ...
  async ({
    ...
    await expect(container).toMatchScreenshot("RadioGroup edge cases");
  },
);
