...
export { type RemoteCodeEditorElement } from "@mittwald/flow-remote-elements";

export const CodeEditor = createFlowRemoteComponent(
  "flr-code-editor",
  "CodeEditor",
  RemoteCodeEditorElement,
  {
    ...
    eventProps: {
      ...
      onCreateEditor: { event: "createEditor" } as never,
      ...
      onStatistics: { event: "statistics" } as never,
      ...
      onUpdate: { event: "update" } as never,
