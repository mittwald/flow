...
export { type RemoteCoachMarkElement } from "@mittwald/flow-remote-elements";

export const CoachMark = createFlowRemoteComponent(
  "flr-coach-mark",
  "CoachMark",
  RemoteCoachMarkElement,
  {
    ...
    eventProps: {
      ...
      onBlurWithin: { event: "blurWithin" } as never,
      ...
      onFocusWithin: { event: "focusWithin" } as never,
      onFocusWithinChange: { event: "focusWithinChange" } as never,
