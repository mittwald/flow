...
<script lang="ts">
  ...
  let props: FlowRemoteProps<RemoteItemsGridListItemElementProps> = $props();
</script>

<RemoteElement
  tag="flr-items-grid-list-item"
  name="ItemsGridListItem"
  element={RemoteItemsGridListItemElement}
  {...props}
/>
