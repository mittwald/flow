...
export const IconMittwald = svgIcon("Mittwald", {
  tag: "svg",
  attributes: {
  ...
  children: [
    ...
    },
    {
      tag: "path",
      attributes: {
        d: "M1569.2,23.7c-83,0-152.4,69.5-152.4,154.3c0,83,69.5,152.4,152.4,152.4c84.9,0,154.4-69.5,154.4-152.4 C1723.5,93.1,1654.1,23.7,1569.2,23.7z",
      },
      children: [],
    },
  ],
