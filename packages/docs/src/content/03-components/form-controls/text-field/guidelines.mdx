...
- Stelle sicher, dass das [Label](/02-components/content/label) prägnant,
...
[ColumnLayouts](/02-components/structure/column-layout) platziert und füllt dort
...
Nutze ein 1:1 [ColumnLayout](/02-components/structure/column-layout) für
...
- einem [Label](/02-components/content/label) für Informationen, die essenziell
...
<DoAndDont>
  ...
  <Do example="default">
    Verwende das [Label](/02-components/content/label) für essentielle Informationen und die FieldDescription für Ergänzungen, z.B. Formatierungshinweise oder Beispiele.
...
- immer ein [Label](/02-components/content/label) verwenden, welches essenzielle
