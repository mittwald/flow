...
<DoAndDont>
  ...
  <Do example="default">
    ...
    Verwende das [Label](/03-components/content/label) für essentielle Informationen und die FieldDescription für
    Ergänzungen, z.B. Formatierungshinweise oder Beispiele.
