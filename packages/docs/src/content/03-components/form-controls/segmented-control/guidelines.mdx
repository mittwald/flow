...
<Do>
  Wähle bitte eine Bankverbindung für die Bezahlung mit SEPA-Lastschrift aus.
  TextField: Kontoinhaber Do Das SegmentedControl steht über dem angepassten
  Inhalt.
</Do>
...
<DoAndDont>
  <Do example="textDo">
    Do Das Label und die Antwortmöglichkeiten sind prägnant und verständlich.
  </Do>
  <Dont example="textDont">
    Don't Kürzer ist oft besser. Versuche, so wenig Wörter wie möglich im Label
...
Falls SegmentedControl ohne Label verwendet wird, muss ein AriaLabel gepflegt
werden.
