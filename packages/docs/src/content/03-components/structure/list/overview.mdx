...
Aktiviere die Kachel Darstellung über die `tile` Property. Dadurch erhält die
Liste die Möglichkeit auf die Ansicht "Kacheln" zu wechseln. Es muss hierfür
keine eigene View angelegt werden. die Kachelansicht nutzt die normale Item
View, und ordnet die Elemente darin entsprechend an.
