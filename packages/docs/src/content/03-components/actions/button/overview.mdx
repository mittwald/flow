...
Beim Button wird zwischen den Variants **Solid, Soft** und **Plain**
unterschieden.
...
Zusätzlich zu den Standard-Colors, können Button in Light und Dark dargestellt
werden. Beide Colors sind alternativen zu den herkömmlichen Farben, falls diese
nicht auf farbigen/dekorativen Hintergründen funktionieren.
...
Im Content-Bereich des Buttons kan entweder **Text**, ein **Icon** oder **Text
...
**Disabled:** Verwende den Disabeld State, wenn der Button keine Aktion oder
