...
Basis-Klassennamen für das grundsätzliche Styling erhalten (`flow--icon`), sowie
den spezialisierten Klassennamen (`flow--alert--alert-icon`), um spezifische
