...
import styles from "./MittwaldIcon.module.css";

export const MittwaldIcon: FC = () => {
  return (
    <Icon size="l" className={styles.mittwaldIcon}>{`
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1746.7 1232" focusable="false" role="img" aria-hidden="true">
